...
const CandyMachine = ({ walletAddress, myWallet }) => {
	...
	// #######################################################################
	// ############# BOILER PLATE CANDY MACHINE MINT CODE ####################
	// #######################################################################
	...
	const mintToken = async () => {
		...
		console.log('walletAddress.publicKey', walletAddress.publicKey)
	...
	// #######################################################################
	// ############# END OF : BOILER PLATE CANDY MACHINE MINT CODE ###########
	// #######################################################################

	// NOTE: Get Provider function to help getting Candy Machine State
	const getProvider = () => {
		const rpcHost = process.env.REACT_APP_SOLANA_RPC_URL
		//Create a new connection object
		//NOTE: Take connection from Solana/web3.js or anchor.web3 ? as shown in https://github.com/metaplex-foundation/metaplex/blob/master/js/packages/candy-machine-ui/src/App.tsx
...
// 						<Link to='cabinet'>medals cabinet</Link> to see your new
// 						medal !
// 					</span>
// 				</>
// 			) : (
